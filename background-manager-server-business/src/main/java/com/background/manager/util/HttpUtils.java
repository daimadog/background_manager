...
public class HttpUtils {
    ...
    public static String sendGet(String url, String param, String contentType) {
        ...
        try {
            ...
            log.error("调用HttpUtils.sendGet ConnectException, url=" + url + ",param=" + param, var23);
        } catch (SocketTimeoutException var24) {
            log.error("调用HttpUtils.sendGet SocketTimeoutException, url=" + url + ",param=" + param, var24);
        } catch (IOException var25) {
            log.error("调用HttpUtils.sendGet IOException, url=" + url + ",param=" + param, var25);
        } catch (Exception var26) {
            log.error("调用HttpsUtil.sendGet Exception, url=" + url + ",param=" + param, var26);
        } finally {
            try {
                if (in != null) {
                    in.close();
