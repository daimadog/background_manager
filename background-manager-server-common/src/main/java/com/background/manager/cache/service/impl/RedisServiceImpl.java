package com.background.manager.cache.service.impl;
...
public class RedisServiceImpl implements RedisService {
    ...
    @Override
    public Set<String> getKeys(String keyword) {
    ...
    public Set<String> scan(String key, Integer count) {
        return redisTemplate.execute((RedisCallback<Set<String>>) connection -> {
            ...
            Cursor<byte[]> cursor = connection
                    .scan(new ScanOptions.ScanOptionsBuilder()
                            .match("*" + key + "*")
                            .count(count).build());
    ...
    @Override
    public Distance geoCalculationDistance(String key, String placeOne, String placeTwo) {
        return redisTemplate.opsForGeo()
                .distance(key, placeOne, placeTwo, RedisGeoCommands.DistanceUnit.KILOMETERS);
    }
