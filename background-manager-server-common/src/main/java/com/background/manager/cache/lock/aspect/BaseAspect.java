package com.background.manager.cache.lock.aspect;
...
public class BaseAspect {
     ...
     * 通过spring SpEL 获取参数
     *
     * @param key            定义的key值 以#开头 例如:#buyeruser
     * @param parameterNames 形参
     * @param values         形参值
     * @param keyConstant    key的常亮
     * @return {@link List}<{@link String}>
     */
    public List<String> getValueBySpEL(String key, String[] parameterNames,
                                       Object[] values, String keyConstant) {
